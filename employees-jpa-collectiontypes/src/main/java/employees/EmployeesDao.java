...
//            }
    ...
    public String findPhonesById(long id, String type) {
        try (EntityManager em = emf.createEntityManager()) {
            Map<String, String> phones = em.createQuery("select e.phones from Employee e where e.id = :id", Map.class).getSingleResult();
